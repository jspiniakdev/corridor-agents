...
| `loop_simulate.py` (new in 11a, not yet built) | Continuous run over a tick budget; survival / throughput / death readout instead of the 6-tuple tick dump `simulate.py` produces. |
